    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          Criamos com as melhores práticas para garantir estabilidade e
          qualidade.
        </p>
      </motion.div>
      <motion.div
      ...
      >
        <p className="text-xs text-neutral-500">Iterações rápidas.</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 shrink-0" />
      </motion.div>
    </motion.div>
  );
