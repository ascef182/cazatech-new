...
export const WebsiteSchema = () => (
  <JsonLd
    data={{
      "@type": "WebSite",
      "@id": "https://cazatech.com.br/#website",
      "url": "https://cazatech.com.br",
      "name": "CazaTech - Automação WhatsApp",
      "description": "Automatize seu WhatsApp e venda 3x mais com nossa plataforma de automação inteligente",
      "publisher": {
        "@id": "https://cazatech.com.br/#organization"
      },
      "potentialAction": [
        {
          "@type": "SearchAction",
          "target": {
            "@type": "EntryPoint",
            "urlTemplate": "https://cazatech.com.br/search?q={search_term_string}"
          },
