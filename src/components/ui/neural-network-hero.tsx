...
export default function NeuralNetworkHero({
  title = "Tecnologia que escala seu negócio.",
  description = "Automações inteligentes, SaaS sob demanda e marketing digital. Do conceito ao lançamento, transformamos ideias em resultados.",
  badgeText = "Tecnologia Premium",
  badgeLabel = "CazaTech",
  ctaButtons = [
    { text: "Começar Projeto", href: "/contact", primary: true },
    { text: "Ver Soluções", href: "/automacoes" }
  ],
  microDetails = ["Automação 24/7", "Entrega Ágil", "Suporte Dedicado"]
}: HeroProps) {
