...
export function BenefitsSection() {
  ...
  useEffect(() => {
    ...
    const scroll = () => {
      ...
      if (scrollContainer) {
        ...
        // Reset quando chegar ao final (loop infinito)
  ...
  // Duplicar benefits para criar efeito infinito
    ...
    <section className="py-20 md:py-32 bg-neutral-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-neutral-950 to-transparent pointer-events-none" />
          <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-neutral-950 to-transparent pointer-events-none" />
        </div>
      </div>
    </section>
  );
