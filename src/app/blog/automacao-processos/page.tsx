...
export async function generateMetadata({ params }: { params: { slug: string } }) {
  const post = await getBlogPost(params.slug, 'pt');
      ...
      <article className="container py-16 max-w-4xl">
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50 rounded-xl text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Implemente soluções de automação e desenvolvimento que realmente geram resultados.
          </p>
          <Link
            href="https://wa.me/5511936205799?text=Oi! Vi o artigo sobre {post.category} e quero saber mais"
            target="_blank"
